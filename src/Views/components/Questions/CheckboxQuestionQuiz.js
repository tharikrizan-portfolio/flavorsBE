...
import { Checkbox, TextField, Button, Switch } from '@material-ui/core';
...
const CheckBoxQuestionQuiz = ({ questionProp, updateRedux, isAddSurvey }) => {
...
CheckBoxQuestionQuiz.propTypes = {
  questionProp: PropTypes.object,
  updateRedux: PropTypes.func,
};

export default memo(CheckBoxQuestionQuiz);
