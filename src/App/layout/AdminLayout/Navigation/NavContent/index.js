...
import ImgLogout from './LogoutImage/logout.png';
import './LogoutImage/LogoutImage.css';
        ...
        <div className="navbar-content sidenav-horizontal" id="layout-sidenav">
          ...
          <div id="sidenav-wrapper" className="sidenav-horizontal-wrapper">
            ...
            >
              ...
              >
                <img src={ImgLogout} className="logout-image" /> Logout
              </a>
            </ul>
          </div>
          <a
      ...
      mainContent = (
        <div className="navbar-content datta-scroll">
          <PerfectScrollbar>
            ...
            <ul style={{ position: 'fixed', bottom: '33px' }} className="nav pcoded-inner-navbar">
              <li>
                <a
                  href={DEMO.BLANK_LINK}
                  className="dropdown-item"
                ...
                >
                  <img src={ImgLogout} className="logout-image" />
